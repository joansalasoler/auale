...
class GTKView(object):
    ...
    def __init__(self, path = None):
        ...
        # Interface localization and style sheet
        
        self._set_textdomain(App.DOMAIN, GTKView.__MESSAGES_PATH)
    ...
    def _set_textdomain(self, domain, path):
        """Initializes this interface translations"""
        ...
        try:
            ...
            print "Warning: Cannot set text domain"
    ...
    def on_home_activate(self, widget):
        ...
        uri = 'http://www.joansala.com/auale/'
    ...
    def on_support_activate(self, widget):
        ...
        uri = 'http://www.joansala.com/auale/forum/'
        webbrowser.open(uri, autoraise = True)
    ...
    def on_rules_activate(self, widget):
        ...
        uri = 'http://www.joansala.com/auale/rules/'
        webbrowser.open(uri, autoraise = True)
